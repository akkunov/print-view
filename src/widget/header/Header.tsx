        ...
        <header className={s.siteHeader}>
            <div className={s.contentContainer}>
                ...
                <nav className={s.siteNav} aria-label="Основной">
                    ...
                    <ul id="nav-list" data-open={isOpen}>
                        <li>
                        ...
                        <li>
                            <NavLink
                                to="https://github.com/akkunov/print-view"
                                target="_blank"
                                className={s.navItem}
                            >
                                Исходный код
